# Spec — Gmail Label Organizer

> **Frozen source of truth.** This is the original build prompt, preserved
> verbatim. Do **not** edit it — if requirements change, raise a new spec
> revision. The living project documentation lives in `README.md`; this file
> stays as the immutable reference.
